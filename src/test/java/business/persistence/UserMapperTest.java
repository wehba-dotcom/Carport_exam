...
public class UserMapperTest {
    ...
    private final static String USER = "wehba";
    ...
    public void setUp() {
            ...
            try ( Statement stmt = database.connect().createStatement() ) {
                ...
                stmt.execute("create table " + TESTDATABASE + ".users LIKE " + DATABASE + ".user;" );
                stmt.execute(
                    "insert into user values (4,'wehba','jens@somewhere.com','bornholm','234324','678000','customer','123') ");
   ...
   /* @Test
    public void testCreateUser01() throws UserException {
        ...
        User original = new User(name, email, adress, "king@kong.com", balance, "uhahvorhemmeligt", "konge" );
